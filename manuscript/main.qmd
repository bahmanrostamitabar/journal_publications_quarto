...
{{< include "03-experiment.qmd" >}}

{{< include "04-htsgts.qmd" >}}
...
All materials to reproduce this paper is available at [github.com/bahmanrostamitabar/forecasting-emergency-medicine](https://github.com/bahmanrostamitabar/forecasting-emergency-medicine). The repository contains the raw data, all R scripts used in experiments, the results used in the paper, as well as the quarto files for producing this paper. Full instructions are provided in the repository.
