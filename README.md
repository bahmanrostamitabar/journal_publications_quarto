...
* `journal_correspondence` contains cover letter, title page, and response letters
* `results` contains outputs of rscripts 
* `literature_table` contaisn a csv file that sumamrises relevant papers from the literature
